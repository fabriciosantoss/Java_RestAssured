...
public class AccountTest extends BaseTest {
    ...
    public void getAccountsWithoutPermission() {
        ...
        response.then().log().all();
        response.then().assertThat().body(JsonSchemaValidator.matchesJsonSchemaInClasspath("payloads/AccountsWithoutPermission.json")).statusCode(403);
    }
    ...
    public void getAccountsWithInvalidDate() {
        ...
        Response response = given()
                ...
                .get(BASE_URI+ ACCOUNTS);
        response.then().log().all();
        response.then().assertThat().body(JsonSchemaValidator.matchesJsonSchemaInClasspath("payloads/AccountsWithInvalidDate.json")).statusCode(403);
    }
    ...
    public void getAccount() {
        ...
        responseAccount.then().body(JsonSchemaValidator.matchesJsonSchemaInClasspath("payloads/AccountInfo.json")).log().all().assertThat().statusCode(200);
    }
